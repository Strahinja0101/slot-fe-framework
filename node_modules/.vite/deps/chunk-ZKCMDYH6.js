...
var loadWebFont = {
  ...
  async load(url2, options) {
    ...
    if (fonts) {
      const fontFaces = [], name = ((_a = options.data) == null ? void 0 : _a.family) ?? getFontFamilyName(url2), weights = ((_c = (_b = options.data) == null ? void 0 : _b.weights) == null ? void 0 : _c.filter((weight) => validWeights.includes(weight))) ?? ["normal"], data = options.data ?? {};
      for (let i2 = 0; i2 < weights.length; i2++) {
        const weight = weights[i2], font = new FontFace(name, `url(${encodeURIWhenNeeded(url2)})`, {
          ...data,
          weight
        });
...
var loadTextures = {
  ...
  async load(url2, asset, loader) {
    ...
    options.resolution ?? (options.resolution = lib_exports.getResolutionOfUrl(url2)), useImageBitmap && ((_a = options.resourceOptions) == null ? void 0 : _a.ownsImageBitmap) === void 0 && (options.resourceOptions = { ...options.resourceOptions }, options.resourceOptions.ownsImageBitmap = true);
  ...
  async unload(assetsToUnloadIn) {
    const promises = convertToList(assetsToUnloadIn, (item) => ({
      ...
      if (loadPromise) {
        ...
        delete this.promiseCache[url2], (_b = (_a = loadPromise.parser) == null ? void 0 : _a.unload) == null ? void 0 : _b.call(_a, loadedAsset, asset, this);
      }
    });
...
var Resolver = class {
  ...
  getAlias(asset) {
    ...
    return convertToList(
      alias || name || src || srcs,
      (value) => typeof value == "string" ? value : Array.isArray(value) ? value.map((v2) => (v2 == null ? void 0 : v2.src) ?? (v2 == null ? void 0 : v2.srcs) ?? v2) : (value == null ? void 0 : value.src) || (value == null ? void 0 : value.srcs) ? value.src ?? value.srcs : value,
      true
    );
  }
  /**
...
var AssetsClass = class {
  ...
  async _detectFormats(options) {
    ...
    return formats = formats.filter((format2, index) => formats.indexOf(format2) === index), formats;
  }
...
*/
//# sourceMappingURL=chunk-ZKCMDYH6.js.map
